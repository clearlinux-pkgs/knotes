...
Version  : 19.04.2
Release  : 8
URL      : https://download.kde.org/stable/applications/19.04.2/src/knotes-19.04.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.2/src/knotes-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/knotes-19.04.2.tar.xz.sig
Summary  : Popup notes
...
export LANG=C
export SOURCE_DATE_EPOCH=1559932735
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libknotesprivate.so.5.11.2
/usr/lib64/libnotesharedprivate.so.5
/usr/lib64/libnotesharedprivate.so.5.11.2
