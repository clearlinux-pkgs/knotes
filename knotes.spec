...
Version  : 24.02.2
Release  : 70
URL      : https://download.kde.org/stable/release-service/24.02.2/src/knotes-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/knotes-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/knotes-24.02.2.tar.xz.sig
...
%setup -q -n knotes-24.02.2
cd %{_builddir}/knotes-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712895314
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libknotesprivate.so.6.0.2
/V3/usr/lib64/libnotesharedprivate.so.6.0.2
...
/usr/lib64/libknotesprivate.so.6.0.2
/usr/lib64/libnotesharedprivate.so.6
/usr/lib64/libnotesharedprivate.so.6.0.2
