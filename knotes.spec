...
Version  : 23.08.1
Release  : 62
URL      : https://download.kde.org/stable/release-service/23.08.1/src/knotes-23.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/knotes-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/knotes-23.08.1.tar.xz.sig
Summary  : Popup notes
...
%prep
%setup -q -n knotes-23.08.1
cd %{_builddir}/knotes-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695096340
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libknotesprivate.so.5.24.1
/V3/usr/lib64/libnotesharedprivate.so.5.24.1
...
/usr/lib64/libknotesprivate.so.5.24.1
/usr/lib64/libnotesharedprivate.so.5
/usr/lib64/libnotesharedprivate.so.5.24.1
