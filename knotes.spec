...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/knotes-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/knotes-24.05.0.tar.xz.sig
...
%setup -q -n knotes-24.05.0
cd %{_builddir}/knotes-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716607031
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libknotesprivate.so.6.1.0
/V3/usr/lib64/libnotesharedprivate.so.6.1.0
...
/usr/lib64/libknotesprivate.so.6.1.0
/usr/lib64/libnotesharedprivate.so.6
/usr/lib64/libnotesharedprivate.so.6.1.0
