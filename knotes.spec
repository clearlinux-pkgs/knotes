...
Version  : 21.12.2
Release  : 39
URL      : https://download.kde.org/stable/release-service/21.12.2/src/knotes-21.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.2/src/knotes-21.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.2/src/knotes-21.12.2.tar.xz.sig
Summary  : Popup notes
...
%prep
%setup -q -n knotes-21.12.2
cd %{_builddir}/knotes-21.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644181833
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knotes-21.12.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/knotes/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/knotes-21.12.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/knotes/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/knotes-21.12.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/knotes/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/knotes-21.12.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/knotes/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/knotes-21.12.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/knotes/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/knotes-21.12.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/knotes/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/knotes-21.12.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/knotes/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/knotes-21.12.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/knotes/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/knotes-21.12.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/knotes/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
/usr/lib64/libknotesprivate.so.5.19.2
/usr/lib64/libnotesharedprivate.so.5
/usr/lib64/libnotesharedprivate.so.5.19.2
