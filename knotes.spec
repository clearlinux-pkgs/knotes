...
Version  : 19.12.3
Release  : 20
URL      : https://download.kde.org/stable/release-service/19.12.3/src/knotes-19.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/knotes-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/knotes-19.12.3.tar.xz.sig
Summary  : Popup notes
...
%prep
%setup -q -n knotes-19.12.3
cd %{_builddir}/knotes-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583534240
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knotes-19.12.3/COPYING %{buildroot}/usr/share/package-licenses/knotes/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/knotes-19.12.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/knotes/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/knotes-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/knotes/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/knotes-19.12.3/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/knotes/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
...
/usr/lib64/libknotesprivate.so.5.13.3
/usr/lib64/libnotesharedprivate.so.5
/usr/lib64/libnotesharedprivate.so.5.13.3
