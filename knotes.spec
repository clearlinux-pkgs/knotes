...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/knotes-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/knotes-23.04.0.tar.xz.sig
Summary  : Popup notes
...
%prep
%setup -q -n knotes-23.04.0
cd %{_builddir}/knotes-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682112696
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libknotesprivate.so.5.23.0
/usr/lib64/libnotesharedprivate.so.5
/usr/lib64/libnotesharedprivate.so.5.23.0
