...
Version  : 23.08.2
Release  : 63
URL      : https://download.kde.org/stable/release-service/23.08.2/src/knotes-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/knotes-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/knotes-23.08.2.tar.xz.sig
Summary  : Popup notes
...
%prep
%setup -q -n knotes-23.08.2
cd %{_builddir}/knotes-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697405664
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libknotesprivate.so.5.24.2
/V3/usr/lib64/libnotesharedprivate.so.5.24.2
...
/usr/lib64/libknotesprivate.so.5.24.2
/usr/lib64/libnotesharedprivate.so.5
/usr/lib64/libnotesharedprivate.so.5.24.2
