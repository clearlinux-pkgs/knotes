...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/knotes-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/knotes-24.02.0.tar.xz.sig
Summary  : Popup notes
...
%prep
%setup -q -n knotes-24.02.0
cd %{_builddir}/knotes-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710435267
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libknotesprivate.so.6.0.0
/V3/usr/lib64/libnotesharedprivate.so.6.0.0
...
/usr/lib64/libknotesprivate.so.6.0.0
/usr/lib64/libnotesharedprivate.so.6
/usr/lib64/libnotesharedprivate.so.6.0.0
